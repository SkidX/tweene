...
window.Tweene = new Tweene();

var Tw = window.Tweene;
...
{    
    ...
    this._easing = window.Tweene.defaultEasing;

    this._duration = this._parseTime(window.Tweene.defaultDuration);
 ...
 * 
 */   
window.Tweene.registerDriver('Dummy', 'tween', function() {
    Common.call(this);
 ...
 *  
 */
window.Tweene.registerDriver('Gsap', 'tween', function(){
    Common.call(this);
    TweenCommon.call(this);
 ...
 *  
 */
window.Tweene.registerDriver('Gsap', 'timeline', function(){
    Common.call(this);
...
window.Tweene.defaultTimeUnit = 's';
window.Tweene.defaultDriver = 'gsap';
 ...
 *  
 */
window.Tweene.registerDriver('velocity', 'tween', function() { 
    Common.call(this);
    TweenCommon.call(this);
    ControlsPro.call(this);
    TweenPro.call(this);    
 ...
 *  
 */
window.Tweene.registerDriver('velocity', 'timeline', function() {    
    Common.call(this);
    TimelineCommon.call(this);
    ControlsPro.call(this);
...
window.Tweene.defaultTimeUnit = 'ms';
window.Tweene.defaultDriver = 'velocity';
 ...
 *  
 */
window.Tweene.registerDriver('transit', 'tween', function() { 
    Common.call(this);
    TweenCommon.call(this);
    ControlsPro.call(this);
    TweenPro.call(this);    
 ...
 *  
 */
window.Tweene.registerDriver('transit', 'timeline', function() {    
    Common.call(this);
    TimelineCommon.call(this);
    ControlsPro.call(this);
    TimelinePro.call(this);    
...
window.Tweene.defaultTimeUnit = 'ms';
window.Tweene.defaultDriver = 'transit';
...
if('jQuery' in window)
{
    window.jQuery.extend({ tweeneBezier: function(coOrdArray) {
        var encodedFuncName = "tweenebez_" + window.jQuery.makeArray(arguments).join("_").replace(/\./g, "p");
        if (typeof window.jQuery.easing[encodedFuncName] !== "function") 
        {
            window.jQuery.easing[encodedFuncName] = function(x, time, b, c, d) 
            {
 ...
 *  
 */
window.Tweene.registerDriver('jquery', 'tween', function() { 
    Common.call(this);
    TweenCommon.call(this);
    ControlsPro.call(this);
    TweenPro.call(this);    
 ...
 *  
 */
window.Tweene.registerDriver('jquery', 'timeline', function() {    
    Common.call(this);
    TimelineCommon.call(this);
    ControlsPro.call(this);
    TimelinePro.call(this);    
...
window.Tweene.defaultTimeUnit = 'ms';
window.Tweene.defaultDriver = 'jquery';


}(window));
//# sourceMappingURL=Tweene-all.js.map